              ...
              <div className="flex flex-col min-h-screen">
                ...
                <header className="flex items-center justify-between px-4 py-3 bg-ink-800/80 border-b border-ink-700/50 backdrop-blur sticky top-0 z-40">
                  <div className="flex items-center gap-2">
                    <span className="text-primary-400 font-display font-bold text-lg tracking-tight">
                      Supekar
                    </span>
                    <span className="text-ink-200 font-display font-bold text-lg tracking-tight">
                      Garments
                    </span>
                  </div>
